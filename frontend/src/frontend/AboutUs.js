            ...
            <section className='ptb-4'>
                <div className="container py-4">
                    <div className="row gap-3 align-items-center about-order-sec">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <img src="https://cloud.shopsppl.com/wp-content/uploads/sppl/thomson/about/about-1.webp" alt="about-1" className='img-fluid' />
                        </div>
                    </div>
                </div>
                <div className="container py-4">
                    <div className="row gap-3 align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <h6 className="text-uppercase fs-5 pb-3">AFFORDABLE AND FAIR PRICES</h6>
                ...
                <div className="container py-4">
                    <div className="row gap-3 align-items-center about-order-sec">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <img src="https://cloud.shopsppl.com/wp-content/uploads/sppl/thomson/about/about-3.webp" alt="about-3" className='img-fluid' />
                        </div>
                    </div>
                </div>
                <div className="container py-4">
                    <div className="row gap-3 align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <h6 className="text-uppercase fs-5 pb-3">SUSTAINABLE PRODUCTS</h6>
                    ...
                    <div className="container">
                        <div className="row align-items-center made-india">
                            ...
                            <div className="col-lg-3 col-md-3">
                                <img src="https://cloud.shopsppl.com/wp-content/uploads/sppl/thomson/about/about-5.webp" alt="about-5" className='img-fluid p-2' />
                            </div>
                        </div>
                    </div>
                </div>
