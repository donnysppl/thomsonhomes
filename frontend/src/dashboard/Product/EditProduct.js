...
export default function EditProduct() {
    ...
    useEffect(() => {
        ...
        const productPrevData = async () => {
            ...
            .then(res => {
                console.log(res);
                if (res.status === 200) {
                    setaddProduct(res.response);
                    setFormValues(res.response.productrpd);
                    setdiscription(res.response.discription);
    ...
    const addProdHandle = async (e) => {
        ...
        await fetch(nodeurl + `product/edit/${id}`, requestOptions)
            .then(res => res.json())
            .then(res => {
                console.log(res);
                if (res.status === 200) {
                ...
                <div className="container">
                    <div className="col-lg-10 mx-auto">
                        <div className="action-header-part dashboard-bg-light rounded-3 p-4">
                            ...
                            <ActionHeader actiontext={'Edit Product'} actionlinktext={'Back'} actionlink={'/admin/product'} />
                            ...
                            <div>
                                <form onSubmit={addProdHandle} >
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" id="name" name="name" value={addProduct.name}
                                            onChange={inputHandler} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="slug" className="form-label">Product Slug</label>
                                        <input type="text" className="form-control" id="slug" name="slug" value={addProduct.slug}
                                            onChange={inputHandler} />
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select className="form-select" name='category' id="category" value={addProduct.category} defaultValue={'DEFAULT'} onChange={inputCateHandler}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" id="model" name="model" value={addProduct.model}
                                            onChange={inputHandler} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="shortdiscrip" className="form-label">Short Discription</label>
                                        <input type="text" className="form-control" id="shortdiscrip" name="shortdiscrip" value={addProduct.shortdiscrip}
                                            onChange={inputHandler} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="buylink" className="form-label">Buy Link</label>
                                        <input type="text" className="form-control" id="buylink" name="buylink" value={addProduct.buylink}
                                            onChange={inputHandler} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="discription" className="form-label">Discription</label>
                                        <CKEditor editor={Editor} data={discription} id="discription" name="discription"
                                            onReady={(editor) => {
