...
export default function AddBS() {
  ...
  let handleSubmit = async (e) => {
    ...
    await fetch(nodeurl + 'brand-store/add', {
      method: 'POST',
                            ...
                            <div className="form-input position-relative" key={index}>
                              ...
                              <div className="form-inline d-flex gap-4 align-items-end">
                                <div className="flex-fill">
                                  ...
                                  <input required className="form-control formimage" type="text" name="imageurl" onChange={e => handleChange(index, e)} />
                                </div>
                                <div className="flex-fill">
                                  <label className="form-label">Image Link</label>
                                  <input required className="form-control formimagelink" type="text" name="imagelink" onChange={e => handleChange(index, e)} />
                                </div>
                                <div className="flex-fill">
                                  <label className="form-label">Section Size</label>
                                  <select required className="form-select" name="sectionsize" defaultValue={''} onChange={e => handleChange(index, e)} >
